...
start_approved = 'שלום {first_name}! אתה מוזמן לשלוח לי מה חדש אצלך בעסק בכל רגע'
start_not_approved = 'שלום {first_name}! כרגע הינך עוד לא רשום לשירות, נסה שוב מאוחר יותר'